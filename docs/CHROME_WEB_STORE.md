...
This writes `dist/chrome-web-store/` with the extension zip, required icon, promotional images, screenshots, `listing.md`, `privacy.md`, and a short upload README. Review every generated image before submitting.
