...
Use the Chrome extension on ChatGPT, Claude, or Gemini in the browser to save full raw chat transcripts. Use the Mac app to import recent local Codex and Claude Code agent transcripts, or to save visible text from open ChatGPT, Claude, and Codex desktop app chats. Tacket stores saved chats on your Mac, makes them searchable, and lets you copy or send saved conversations to Codex, Claude Code, or your clipboard when you need the context again.
...
Tacket has two local pieces: a Chrome extension for full browser chat transcripts and a Mac app for storing, searching, local agent transcript import, visible desktop capture, and transfer. Browser saves go directly from the extension to the Tacket app on your Mac. Agent imports read local Codex and Claude Code JSONL session files only after you click import. Desktop app capture uses local macOS Accessibility and on-device OCR to read visible app text. Saved chat text is not sent to me or to a Tacket server.
...
- Imports recent local Codex and Claude Code agent transcripts only after you click import.
- Captures visible text from open ChatGPT, Claude, and Codex desktop app chats from the Mac app.
...
1. Open a ChatGPT, Claude, or Gemini conversation in Chrome and click the Tacket extension; import recent Codex or Claude Code transcripts from the Mac app; or open a ChatGPT, Claude, or Codex desktop app chat and click its visible capture button in Tacket.
2. Choose **Save Conversation** in the extension, **Import Codex** / **Import Claude Code** in the Mac app, or let the Mac app capture the open desktop chat locally.
...
Local agent transcript import does not need Accessibility or Screen Recording. It reads recent Codex and Claude Code JSONL session files from your home folder when you click import, converts them into `.tacket` folders, and indexes them locally.
